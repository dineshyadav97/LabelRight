...
public class LabelRightAutomationTest {
	...
	public void test1() throws InterruptedException, IOException {
		...
		while (itr.hasNext()) {
			...
			RegionCategoryPackageType regionCategoryPackageType = artworkManualFlows.convertToOptions(regionCategory,
					packageType);

			log.info("Adhoc Flow Started.");
			ArtworkDto artworkDto = artworkManualFlows.Flow1(regionCategoryPackageType.getRegionCategory(),
					regionCategoryPackageType.getPackageType(), artworkUrl, lidUrl);
		...
		resultInterruption.resultInterruptionFlow(Constants.RegionCategory_US_SocialBeverages,
				Constants.Package_Primary, Constants.Flow1ArtworkUrl, Constants.Flow1LidUrl);
