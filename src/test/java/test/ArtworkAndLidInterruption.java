...
public class ArtworkAndLidInterruption {
	...
	public ArtworkAndLidInterruption(WebDriver driver) {
		ArtworkAndLidInterruption.driver = driver;
		ArtworkAndLidInterruption.js = (JavascriptExecutor) driver;
		ArtworkAndLidInterruption.wait = new WebDriverWait(driver, Duration.ofSeconds(10000));
	}

	public void Flow4(int regionOption, int packageType, String artworkUrl, String lidUrl) throws InterruptedException {
